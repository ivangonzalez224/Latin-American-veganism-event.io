<div align="center"> 
  <h3><b>Encuentro Latinoamericano de veganismo</b></h3>
  <h5>Ivan Gonzalez</h5> 
</div>
...
- Use javascript in order to create elements dynamically.
...
- [Live Demo Link](https://ivangonzalez224.github.io/Latin-American-veganism-event.io/)

<p align="right">(<a href="#readme-top">back to top</a>)</p>

## 💻 Getting Started <a name="getting-started"></a>

In this project we build a responsive web site for the Latinoamerican Veganism Event for mobile and desktop versions.
...
Clone this repository to your desired folder:
  ...
  ```sh
  cd my-folder
  git clone https://github.com/ivangonzalez224/Latin-American-veganism-event.git
...
- Add a section showing the program schedule of the event.
- Add a contact form section for people who wants to attend.
